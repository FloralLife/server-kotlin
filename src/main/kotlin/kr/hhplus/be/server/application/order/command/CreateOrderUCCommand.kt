...
fun CreateOrderRequest.toCommand() = CreateOrderUCCommand(
  address, customerId, customerCouponId, products.map { it.toCommand() }
)

fun CreateOrderProductRequest.toCommand() = CreateOrderProductUCCommand(
  productId, amount
)
